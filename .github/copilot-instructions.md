...
|----------|-----------|------|
| `ai21-labs/ai21-jamba-1.5-large` | AI21 Labs | premium |
| `cohere/cohere-command-r-plus-08-2024` | Cohere | premium |
| `cohere/cohere-command-a` | Cohere | standard |
| `cohere/cohere-command-r-08-2024` | Cohere | standard |
...
| `microsoft/mai-ds-r1` | Microsoft | custom |
...
| `xai/grok-3` | xAI | custom |
| `xai/grok-3-mini` | xAI | custom |
